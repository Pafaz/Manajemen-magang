...
export default function TableSurat({ data, searchTerm, selectedDate }) {
      ...
      <table className="w-full table-fixed border-collapse text-sm">
        <thead className="bg-[#F9FAFB] text-[#667085] border-t border-gray-200">
          <tr>
            ...
            <th className="px-3 py-3 text-center font-medium">Tanggal Daftar</th>
            <th className="px-3 py-3 text-center font-medium">Tanggal Diterima</th>
