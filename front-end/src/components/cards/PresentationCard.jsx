  ...
  <div className="p-2 rounded-lg border border-slate-400/[0.5] bg-white cursor-pointer">
    ...
    <div className="flex justify-between border-t border-slate-500 mt-5 py-2">
      ...
      <div className="flex gap-3">
        <i class="bi bi-clock text-[10px] text-blue-500"></i>
        <p className="text-[9px] text-gray-500 font-medium">{item.time}</p>
      </div>
    </div>
    <button className="w-full mt-2 py-2 border border-blue-500 text-blue-500 hover:bg-blue-500 hover:text-white transition-all duration-300 ease-in rounded-full text-sm font-medium">
      Lihat Detail
    </button>
  </div>
);
